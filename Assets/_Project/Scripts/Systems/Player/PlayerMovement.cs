...
namespace _Project.Scripts.Systems.Player
{
    ...
    public class PlayerMovement : MonoBehaviour, IMovable
    {
        ...
        public void Move(Vector2 direction)
        {
            ...
            float speed = _speeds[_speeds.Count - 1];
            if (_currentSpeedIndex < _speeds.Count - 1)
            {
                speed = _speeds[_currentSpeedIndex];
            }

            Vector3 targetVelocity = moveDirection * (speed * Time.deltaTime * 100);
